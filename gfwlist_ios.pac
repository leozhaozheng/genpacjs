/**
 * genpac 1.3.0
 * Generated: 8/30/2026, 10:00:08 PM
 * GFWList Last-Modified: Sun, 30 Aug 2026 14:57:02 +0000
...
var rules = [
    ...
    [
        ...
        [
            ...
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?xn--vuqv2cf7wzyig79c\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?s3\\.dualstack\\.us-west-2\\.amazonaws\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?music\\.amazon\\.com",
            ...
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?fututrade\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?fututrustee\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?cdn\\.futustatic\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?api\\.moomoobull\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?moomooequity\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?moomootrustee\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?9oju31\\.launches\\.appsflyersdk\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?sgqt0j\\.launches\\.appsflyersdk\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?shortconn\\.im\\.qcloud\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?api\\.lbkrs\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?api-gl\\.lbkrs\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?longbridge\\.cloud",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?longbridge\\.sg",
            ...
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?tigerbrokers\\.net",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?tigerbrokers\\.nz",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?quote\\.longbridge\\.global",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?trade\\.longportapp\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?openapi\\.longbridge\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?openapi-quote\\.longbridge\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?openapi-trade\\.longbridge\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?openapi\\.longbridge\\.cn",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?openapi-quote\\.longbridge\\.cn",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?openapi-trade\\.longbridge\\.cn",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?cg\\.play-analytics\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?qtcard\\.futunn\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?qtcardfthk\\.futufin\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?openapi\\.futunn\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?api\\.futunn\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?api5\\.futunn\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?trade\\.futunn\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?support\\.futunn\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?download\\.futunn\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?read01\\.com",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?kknews\\.cc",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?china-mmm\\.net",
            "^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?bgme\\.me",
